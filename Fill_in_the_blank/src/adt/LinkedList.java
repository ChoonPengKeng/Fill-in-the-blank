...
public class LinkedList<T> implements LinkedListInterface<T> {
  ...
  public T remove(int givenPosition) {
    T Ranking = null;                 // return value

    if ((givenPosition >= 1) && (givenPosition <= length)) {
      if (givenPosition == 1) {      // case 1: remove first entry
        Ranking = (T) firstNode.people;     // save entry to be removed
        ...
        Ranking = (T) nodeBefore.next.people;  // save entry to be removed
    ...
    return Ranking; // return removed entry, or null if operation fails
  }
  ...
  public T getEntry(int index) {
    ...
    if ((index >= 1) && (index <= length)) {
      ...
      Ranking = (T) currentNode.people;	// currentNode is pointing to the node at givenPosition
    }

    return Ranking;
  }

    public T getEntryName(int index) {
    T Ranking = null;
    ...
    if ((index >= 1) && (index <= length)) {
      ...
      Ranking = (T) currentNode.people.username;	// currentNode is pointing to the node at givenPosition
    }
  ...
  public boolean contains(String anEntry) {
    ...
    while (!found && (currentNode != null)) {
      if (((String)anEntry).toUpperCase().equals(currentNode.people.username.toUpperCase())) {
        found = true;
      } 
